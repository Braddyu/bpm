 ...
 * @param total   总条数
 * @param footer  底部统计
 * @returns {{success: *, code: *, msg: *, data: *, total: *, footer: *}}
 */
exports.returnMsg4EasyuiPagingFooter = function(success, code, msg, result, total,footer){
    return {'success':success, 'code':code, 'msg':msg, 'rows':result,'total': total,'footer':footer};
}
