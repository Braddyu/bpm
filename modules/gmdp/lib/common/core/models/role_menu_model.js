...
// 快捷菜单
var commonShortcutMenuSchema = new Schema(
    {
        "user_id" : String, // 用户ID
        "menu_id" : {type: Schema.Types.ObjectId, ref: 'CommonCoreRoleMenu'},
        "order_id": Number
    },
    {collection: "common_shortcut_menu_info"}//mongodb集合名
);
// model
var CommonShortcutMenu = mongoose.model('CommonShortcutMenu', commonShortcutMenuSchema);
exports.$CommonShortcutMenu = CommonShortcutMenu;