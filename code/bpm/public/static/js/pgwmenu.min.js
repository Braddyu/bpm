    ...
    a.fn.pgwMenu = function (d) {
        ...
        var b = function () {
            ...
            if (c.config.viewMoreEnabled) {
                c.plugin.append('<div class="pm-viewMore bg-themeprimary" style="display:inline-block"><a href="javascript:void(0)">' + c.config.viewMoreLabel + "</a><ul class='bg-themeprimary'></ul></div>")
            }
        };
            ...
            function i(l) {
                if (l == "viewmore") {
                    ...
                    if (l == "dropdown") {
                        ...
                        c.plugin.find(".pm-links").addClass("mobile").addClass('bg-themeprimary').hide();
