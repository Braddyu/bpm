/**
 * Javascript类描述:       扩展JQuery对时间的处理，URL参数的获取，EasyUI先提示的封装。
 * Javascript名称:         个人工具文件
 * Javascript创建人:       Singularly
 * Javascript创建时间:     2016-10-27 00:00:00
 * Javascript版本:        v1.0
 */
/**
 * ====================================================================================================
...
(function ($) {
    ...
    $.getUrlParam = function (name) {
        ...
        //if (r != null) return unescape(r[2]);建议使用下面一种替换
 ...
 * @param callback     回掉函数
 */
function msgeConfirm(msg, callback) {
    $.messager.confirm('温馨提示', msg, function (result) {
        callback(result);
    });
}
