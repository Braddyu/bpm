        ...
        '<div class="control-group">'+
            '<label class="control-label"><span id="title_label_{{index}}">单项选择</span></label>'+
                '<div class="controls">'+
                    ...
                    '<label class="radio" id="choice_label_{{index}}_0"><input type="radio" value="0" disabled="disabled" id="radio_{{index}}_0"><span id="option_name_{{index}}_0">选项</span></label>'+
                    '<label class="radio" id="choice_label_{{index}}_1"><input type="radio" value="1" disabled="disabled" id="radio_{{index}}_1"><span id="option_name_{{index}}_1">选项</span></label>'+
                    '<label class="radio" id="choice_label_{{index}}_2"><input type="radio" value="2" disabled="disabled" id="radio_{{index}}_2"><span id="option_name_{{index}}_2">选项</span></label>'+
                '</div>'+
                '<input type="hidden" name="step_id" value="'+step_id+'">'+
                ...
                '<input type="hidden" name="field_name" value="" id="field_name_{{index}}">'+
                '<input type="hidden" name="field_option_content" value="选项,选项,选项" id="field_option_{{index}}">'+
                ...
                '<input type="hidden" name="field_option_value" value="0,1,2" id="field_option_value_{{index}}">'+
            '</div>'+
        '</div>'+
    '</div>' ;
        ...
        '<div class="control-group">'+
            ...
            '<div class="controls">'+
                '<div class="choices" id="checks_{{index}}">'+
                    '<label class="checkbox" id="check_label_{{index}}_0"><input type="checkbox" value="0" disabled="disabled" id="check_{{index}}_0"><span id="check_name_{{index}}_0">选项</span></label>'+
                    '<label class="checkbox" id="check_label_{{index}}_1"><input type="checkbox" value="1" disabled="disabled" id="check_{{index}}_1"><span id="check_name_{{index}}_1">选项</span></label>'+
                    '<label class="checkbox" id="check_label_{{index}}_2"><input type="checkbox" value="2" disabled="disabled" id="check_{{index}}_2"><span id="check_name_{{index}}_2">选项</span></label>'+
                '</div>'+
                '<input type="hidden" name="step_id" value="'+step_id+'">'+
...
var dropDownTemplate =
    '<div class="field" id="field_{{index}}" onclick="fieldClickEvent(this, {{index}})">'+
        ...
        '<div class="control-group">'+
            ...
            '<div class="controls">'+
                '<select class="choices" disabled="disabled" style="width:70%" id="select_{{index}}">' +
                    '<option value="">请选择</option>' +
                    '<option value="0" id="sel_option_{{index}}_0">选项</option>' +
                    '<option value="1" id="sel_option_{{index}}_1">选项</option>' +
                    '<option value="2" id="sel_option_{{index}}_2">选项</option>' +
                '</select>'+
                '<input type="hidden" name="step_id" value="'+step_id+'">'+
...
var textSetting =
    ...
    '<div class="field_setting">'+
        ...
        '<div class="col-xs-12"><input type="text" class="full-width" value="" disabled="disabled"></div>'+
    '</div>';
