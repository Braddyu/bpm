        ...
        service.local_user(user_org,user_no)
            .then(function(result) {
                ...
                if (result.success) {
                    ...
                    console.log("params",org_id,proc_code,level,status,startDate,endDate);
                    // 调用分页
                    service.exportDetailList(org_id,proc_code,level,status,startDate,endDate,proc_inst_task_type)
    ...
    service.local_user(user_org,user_no)
        .then(function(result){
            if(result.success){
                ...
                // 调用分页
                service.detail_list(page,size,org_id,level,status,proc_code,dispatch_time,startDate,endDate,proc_inst_task_type,work_order_number)
                    .then(function(result){
                        let end = new Date().getTime()
                        console.log(end-start,"ms");
                        utils.respJsonData(res, result);
