...
router.route('/insert').post(function(req,res){
    ...
    var order_type = req.body.order_type;// 工单类型
    var rewMap={};
...
router.route("/suggestion_list").post(function(req,res){
    ...
    var compare={};
    if(start_date){
        compare['$gte']=new Date(start_date);
    }
    if(end_date){
        compare['$lte']=new Date(end_date);
    }
    if(!isEmptyObject(compare)){
        condition['create_date']=compare;
    }
