...
//     model_user.$CommonCoreOrg.find({level: 5, org_type: '网格'}, function (err, res) {
//         if (err) {
//             console.log(err);
//         } else {
//             // console.log(res);
...
//     if (array && array.length > k) {
//         var org = array[k];
//         let sql = "select DISTINCT a.grid_coding,a.grid_name,a.district_code,a.district_name from grid_manager_info a where 1=1 and a.grid_coding=?"
...
//         map.user_roles = ["5a1fee4d9df6491f0836aeba",];//:[{type:Schema.Types.ObjectId}],//流程使用的角色
...
//                     user_roles.push("5a1fee4d9df6491f0836aeba");
...
//                     var user_roles = res[0].user_roles;
//                     user_roles.push("5a1fc8879df6491f0836ae74");
//                     model_user.$User.update({"_id": user._id}, {$set: {"user_roles": user_roles}}, {}, function (error, result) {
//                         if (err) {
//                             console.log(error);
//
//                         } else {
...
//                     map.user_photo = "";// : String,// 用户头像/照片
//                     map.sys_roles = [];// : [{type: Schema.Types.ObjectId}],// 菜单访问权限使用角色
//                     map.user_roles = ["5a1fc8879df6491f0836ae74",];//:[{type:Schema.Types.ObjectId}],//流程使用的角色
//                     map.boss_id = "";//:String=""//对接外部系统专用的 Boss_id
//                     map.smart_visual_sys_user_id = "";  //:String,//慧眼系统的 User_id
//                     map.athena_sys_user_id = "";//:String=""///Athena系统的user_id
//                     map.athena_app_sys_user_id = "";//:String,//Athena_app系统的user_id
...
//             let sql_channel = "select * from salesperson_info where 1=1 and channel_id=?";
...
//         var org_name=org.org_name;
//
//         model_user.$CommonCoreOrg.find({"org_name": org_name, "org_code": org.org_code}, function (error, result) {
//             if(error){
//                 console.log(error);
