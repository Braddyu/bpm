        ...
        <div class="col-md-12">
            <div>
                <form class="form-horizontal form-bordered" id="orgForm" role="form">
                    ...
                    <div class="form-group">
                        <label for="inputOrgType" class="col-sm-2 control-label no-padding-right">所属地区</label>
                        <div class="col-sm-10">
                            <input id="org_belong" name="org_belong" style="width:300px;height:31px;" />
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    $('#org_belong').combotree({
        method: 'get',
        url: '{{projcfg.appurl}}/public/dict/{{projcfg.org_belong_mapping_key}}',
        editable:false,
        valueField:'id',
        textField:'text',
        //panelHeight:100,
        ...
        $(function(){
            $('#simpledatatable').datagrid({
                ...
                columns:[[
                    ...
                    {"field": "company_code","title":"机构编号","width":50},
                    {"field": "org_name","title":"机构名称","width":50},
                    {"field": "org_fullname","title":"机构全称","width":70},
                    {"field": "org_code_desc","title":"层级","width":50, formatter: function (value) {
                        return "<span title='" + value + "'>" + value + "</span>";
                    }},
                    {"field": "level","title":"机构类别","width":50,
        ...
        $.ajax({
            ...
            data: {
                ...
                if(data.success) {
                    ...
                    $('#org_belong').combotree('setValue',data.data[0].org_belong);
                }
                else {
                    msgError(data.msg+',错误代码:'+data.code);
                }
