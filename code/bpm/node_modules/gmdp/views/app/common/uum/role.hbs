        ...
        <div class="col-md-12">
            <div>
                <form id="roleForm" class="form-horizontal form-bordered" role="form">
                    ...
                    <div class="form-group">
                        <label for="role_name" class="col-sm-2 control-label no-padding-right">角色名称</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="role_level" class="col-sm-2 control-label no-padding-right">角色级别</label>
                        <div class="col-sm-10">
                            <select id="role_level" name="role_level" class="form-control" style="width: 180px;height:31px;">

                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="role_tag" class="col-sm-2 control-label no-padding-right">角色类型</label>
                        <div class="col-sm-10">
                            <select id="role_tag" name="role_tag" class="form-control" style="width: 180px;height:31px;">
                    ...
                    <div class="form-group">
                        <label for="role_order" class="col-sm-2 control-label no-padding-right">角色序号</label>
                        <div class="col-sm-10">
                            <div class="spinbox">
...
<script>
    ...
    var roleLevelVal = '';
    var roleTagVal = '';
    var roleLevel = {{{tostring commonDictData.common_role_level}}};
    var roleTag = {{{tostring commonDictData.common_role_tag}}};
    $(document).ready(function(){
        ...
        $('#roleDataTable').datagrid({
            ...
            columns:[[
                ...
                {"field": "role_tag","title":"角色类别","width":15,
                    "formatter":function (value, rowData,rowIndex) {
                        if(value) {
                            for(var i = 0; i < roleTag.length; i++) {
                                if(roleTag[i].id == value) {
                                    return roleTag[i].text;
                                }
                            }
                        }
                        else {
                ...
                {"field": "role_level","title":"角色级别","width":15,
                    "formatter":function (value, rowData,rowIndex) {
                        if(value) {
                            for(var i = 0; i < roleLevel.length; i++) {
                                if(roleLevel[i].id == value) {
                                    return roleLevel[i].text;
                                }
                            }
                        }
                        else {
            ...
            onCheck:function(rowIndex,rowData){
                roleLevelVal = rowData.role_level;
                roleTagVal = rowData.role_tag;
    ...
    function openPage(title, value, callback) {
        ...
        $('#role_level').combobox({
            method: 'get',
            url: '{{projcfg.appurl}}/public/dict/common_role_level',
            editable:false,
            valueField:'id',
            textField:'text',
            //panelHeight:100,
        ...
        $('#role_tag').combobox({
            method: 'get',
            url: '{{projcfg.appurl}}/public/dict/common_role_tag',
            editable:false,
            valueField:'id',
            textField:'text',
            //panelHeight:100,
